...
public partial class ProductionPage : ContentPage
{
    ...
    private void Send_Clicked(object sender, EventArgs e)
    {
        ...
        if (name.Text != null && phone.Text != null && phone.Text.Length < 15 && editor.Text != null)
        {
            ...
            MySqlCommand cmd_add = new MySqlCommand($"INSERT INTO `ProductionOrders`(`example_image_url`,`status`, `problem`,  `UserId`) VALUES ('{link}','{"new"}','{editor.Text}','{id}')", conn);
